...
پس از تکمیل پیکربندی، می‌توانید از آدرس‌های ایمیل دیگر برای ارسال ایمیل به `i@user.tax` و `any123@user.tax` استفاده کنید تا ببینید آیا می‌توانید ایمیل‌ها را در Gmail دریافت کنید یا خیر.
