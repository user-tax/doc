# Samee server-kaaga SMTP ee boostada
...
Ogsoonow in aan `include:_spf.google.com` halkan, sababtoo ah waxaan u habeyn doonaa `i@user.tax` sida ciwaanka soo dirida ee sanduuqa boostada Google mar dambe.
