...
Labɛnni bannen kɔfɛ, i bɛ se ka baara kɛ ni imayili ladɛrɛsi wɛrɛw ye walasa ka bataki ci `i@user.tax` ani `any123@user.tax` walasa k’a lajɛ n’i bɛ se ka batakiw sɔrɔ Gmail kɔnɔ.
