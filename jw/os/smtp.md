...
Sawise konfigurasi rampung, sampeyan bisa nggunakake alamat email liyane kanggo ngirim email menyang `i@user.tax` lan `any123@user.tax` kanggo ndeleng apa sampeyan bisa nampa email ing Gmail.
