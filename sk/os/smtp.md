...
Po dokončení konfigurácie môžete použiť iné e-mailové adresy na odosielanie e-mailov na `i@user.tax` a `any123@user.tax` , aby ste zistili, či môžete prijímať e-maily v službe Gmail.
