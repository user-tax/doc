...
Kad konfigurācija ir pabeigta, varat izmantot citas e-pasta adreses, lai sūtītu e-pasta ziņojumus uz `i@user.tax` un `any123@user.tax` , lai noskaidrotu, vai pakalpojumā Gmail varat saņemt e-pasta ziņojumus.
