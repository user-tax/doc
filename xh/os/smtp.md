...
Qaphela ukuba ndiquka `include:_spf.google.com` apha, kuba ndizakuqwalasela `i@user.tax` njengedilesi yokuthumela kwibhokisi yemeyile kaGoogle kamva.
...
Intsingiselo yeeparamitha yile ilandelayo
