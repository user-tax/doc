...
បន្ទាប់ពីការកំណត់រចនាសម្ព័ន្ធបានបញ្ចប់ អ្នកអាចប្រើអាសយដ្ឋានអ៊ីមែលផ្សេងទៀតដើម្បីផ្ញើអ៊ីមែលទៅ `i@user.tax` និង `any123@user.tax` ដើម្បីមើលថាតើអ្នកអាចទទួលអ៊ីមែលនៅក្នុង Gmail ដែរឬទេ។
