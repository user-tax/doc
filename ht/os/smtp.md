...
Antre nan depo konfigirasyon ops, kouri `./ssl.sh` , epi yo pral kreye yon katab `conf` nan anyè anwo a.
...
Apre Google Mail resevwa lapòs la, li natirèl pou w vle reponn ak `i@user.tax` olye de i.user.tax@gmail.com.
