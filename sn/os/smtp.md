...
Kana kugadzirisa kwapera, unogona kushandisa mamwe maero eemail kutumira maemail ku `i@user.tax` uye `any123@user.tax` kuona kana uchikwanisa kugamuchira maemail muGmail.
