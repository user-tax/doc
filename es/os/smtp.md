# Cree su propio servidor de envío de correo SMTP
...
Tenga en cuenta que he `include:_spf.google.com` aquí, porque configuraré `i@user.tax` como la dirección de envío en el buzón de Google más adelante.
