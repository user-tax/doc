...
Bayan daidaitawar ta cika, zaku iya amfani da wasu adiresoshin imel don aika imel zuwa `i@user.tax` da `any123@user.tax` don ganin ko kuna iya karɓar imel a cikin Gmel.
