...
Ko je konfiguracija končana, lahko uporabite druge e-poštne naslove za pošiljanje e-pošte na `i@user.tax` in `any123@user.tax` , da preverite, ali lahko prejemate e-pošto v Gmailu.
