...
מטעמי נוחות, שמתי את ההתקנה ותצורת המערכת של תוכנת ubuntu ב- [github.com/user-tax-dev/os/tree/main/ubuntu](https://github.com/user-tax-dev/os/tree/main/ubuntu) .
