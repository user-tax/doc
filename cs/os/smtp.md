...
Po dokončení konfigurace můžete použít jiné e-mailové adresy k odesílání e-mailů na `i@user.tax` a `any123@user.tax` , abyste zjistili, zda můžete přijímat e-maily v Gmailu.
